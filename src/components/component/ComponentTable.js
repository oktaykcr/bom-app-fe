...
export default function ComponentTable({htmlFor, setComponent}) {
        ...
        },
        {
            ...
            Cell: (cellObj) => (
                <div className="flex space-x-2">
                    ...
                    <button onClick={() => handleDeleteComponent(cellObj.row.original["id"])} className="btn btn-outline btn-primary flex-1">
                        <MdDelete size={20} />
                    </button>
                </div>
            )
